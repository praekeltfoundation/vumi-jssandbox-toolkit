...
var state_machine = require("./state_machine");


var Eventable = events.Eventable;
var InteractionMachine = state_machine.InteractionMachine;
...
function DummyIm() {
    ...
    self.emit.session_new = function() {
    };
}
