...
function ImTester(api, opts) {
    ...
    //   - max_content_length: maximum length of content
    ...
    self.max_content_length = opt_or_default(opts.max_content_length,
                                             163);
    ...
    self.check_state = function (opts) {
        ...
        var max_content_length = opt_or_default(opts.max_content_length,
        ...
        self.assert_ok(response.match(expected_response),
                       ...
                       expected_response + "'");
        if (max_content_length !== null) {
            self.assert_ok(response.length <= max_content_length,
