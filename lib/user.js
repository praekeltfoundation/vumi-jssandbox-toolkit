...
var UserStateData = Extendable.extend(function(self, obj) {
    /**class:UserStateData([obj])
    ...
    instance or data about a state the is yet to be created.
    ...
    */
    ...
    self.reset = function(obj) {
        ...
        */
        ...
        /**:UserStateData.reset(state_name)
...
var User = Eventable.extend(function(self, im) {
    ...
    */
    ...
    self.update_metadata = function(metadata) {
        ...
        Update the user's current metadata. Any properties in the current
        metadata with the same names as properties in the new metadata will
        overwritten.

        :param object metadata: the new metadata to add
        */
        utils.update(self.metadata, metadata);
    };
