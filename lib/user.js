...
var UserStateData = Extendable.extend(function(self, obj, metadata) {
    ...
    Constructor has the following forms:
      ...
      ``func(state)``
      :param State state: state instance to keep track of.

      ``func(opts)``
      :param string opts.name: the name of the state to track
      :param object opts.metadata: optional metadata about the state
