...
var UrlParams = Extendable.extend(function(self, query_params) {
    ...
    */
    ...
    self.append_to = function(url) {
        ...
        */
        if (self.param_list.length === 0) return url;
        return utils.url_encode(url, self.param_list);
    };
...
var HttpApi = Eventable.extend(function(self, im, opts) {
    ...
    */
    ...
    self.create_headers = function(headers) {
        ...
        */
        var all_headers = {};
        _.extend(all_headers, self.default_headers);
        _.extend(all_headers, headers);
        return all_headers;
    };
