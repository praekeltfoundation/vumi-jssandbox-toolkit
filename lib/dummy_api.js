...
function DummyApi() {
    ...
    self.add_http_fixture = function(fixture) {
        var data_methods = ['POST', 'PUT'];
        var method_key = 'http_' + fixture.method.toLowerCase();
        if (data_methods.indexOf(fixture.method) >= 0) {
            ...
            self[method_key][key] = JSON.stringify(fixture.body);
        }
        else {
            self[method_key][fixture.url] = JSON.stringify(fixture.body);
        }
    };
