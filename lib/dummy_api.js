...
function DummyApi() {
    ...
    self._http_request_key = function(url, content_type, data) {
        return [
            url || null,
            content_type || null, 
            data || null
    ...
    self._http_request_key_for_fixture = function(fix) {
        return self._http_request_key(fix.url, fix.content_type, fix.data);
    };
    ...
    self.add_http_fixture = function(fixture, opts) {
        utils.set_defaults(fixture, {response_body: null});

        var request_body = fixture.request_body;
        if (request_body && fixture.content_type == "application/json") {
            fixture.request_body = self._order_json_data(request_body);
        }

        var key = self._http_request_key_for_fixture(fixture);
        self.http_calls[fixture.method][key] = fixture.response_body;
    };
    ...
    self._handle_http_method = function(method, cmd) {
        ...
        var body = self.http_calls[method][key];
