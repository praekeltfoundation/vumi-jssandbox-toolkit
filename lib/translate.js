...
var Translator = Extendable.extend(function(self, i18n) {
    /**class:Translator(i18n)
    Constructs functions of the form ``f(text)``, where ``text`` is a string or
    lazy translation constructed by one of :class:`LazyTranslator`'s
    translation methods. If a string is provided, the function acts as a no-op.
    ...
    */
    self = function(text) {
        return apply_translation(self.i18n, text);
    };
