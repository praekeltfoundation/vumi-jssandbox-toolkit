...
var Contact = Extendable.extend(function(self, attrs) {
    ...
    */
    ...
    self.validate = function() {
        ...
        */
        if (!_.isString(self.attrs.msisdn)) {
            throw new ContactError(self, [
                "Contact has an msisdn of type",
                "'" + typeof self.attrs.msisdn + "'",
                "instead of 'string': " + self.attrs.msisdn
            ].join(' '));
        }

        _.each(self.attrs.extra, self.validate.extra);
        _.each(self.attrs.groups, self.validate.group);
    };
    ...
    self.serialize = function() {
        ...
        */
        ...
        var data =  _.clone(self.attrs);
        data.extra = _.clone(data.extra);
        data.groups = _.clone(data.groups);
