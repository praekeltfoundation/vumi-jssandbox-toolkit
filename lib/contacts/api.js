    ...
    */
    ...
    self.cls.validate = function() {
        ...
        */
        ...
        _.each(self.extra, self.validate.extra);
        _.each(self.groups, self.validate.group);
    };

    self.cls.validate.extra = function(value, name) {
        if (!_.isString(name)) {
            throw new ContactError(self, [
    ...
    self.cls.validate.group = function(group) {
        if (!_.isString(group)) {
            throw new ContactError(self, [
