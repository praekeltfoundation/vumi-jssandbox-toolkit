...
Event.subevent = function(name, constructor) {
    var Parent = this;
    ...
    var Child = function() {
        ...
        var data ;
        if (constructor) {
            data = constructor.apply(self, arguments)
        }

        Event.call(self, name, data);
    };
...
var SetupEvent = Event.subevent('setup', function(instance) {
