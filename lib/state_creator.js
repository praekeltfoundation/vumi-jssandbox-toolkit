...
var StateCreator = Eventable.extend(function(self, start_state_name) {
    /**class:StateCreator(start_state_name)
    ...
    */
    ...
    self.add_creator = function(state_name, creator) {
        /**:StateCreator.add_creator(state_name, creator)

         Adds a state creator. Invoked by :meth:`StateCreator.switch_state`, or
    ...
    self.start_state_creator = function(state_name) {
        ...
        :meth:`StateCreator.error_state_creator` instead.
        */
    ...
    self.check_created_state = function(state, state_name) {
        /**StateCreator.check_created_state(state, state_name)

        Used by :meth:`StateCreator.switch_state` to ensure that an invoked
