    ...
    */
    ...
    self.add_state = function(state) {
        ...
        */
        ...
        self.add_creator(state.name, function(state_name) {
            if (opts.translate) {
                state.translate(self.im.user.i18n);
            }
            return state;
        });
    ...
    self.start_state_creator = function(state_name) {
        ...
        */
        ...
        return self.error_state_creator('__error__', self.im);
    };
    ...
    self.switch_state = function(state_name) {
        ...
        */
        ...
        else if (state_name in self.state_creators) {
