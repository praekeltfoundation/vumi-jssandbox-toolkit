...
var InteractionMachine = Eventable.extend(function(self, api, app) {
    ...
    */
    ...
    self.setup = function(msg, opts) {
        ...
        */
        opts = utils.set_defaults(opts || {}, {reset: false});
        ...
        return Q()
            ...
            .then(function() {
                return self.metrics.setup({
                    store_name: self.config.get('metric_store')
            ...
            .then(function() {
                var user_opts = {
                    ...
                    store_name: self.config.get('user_store')
                             || self.config.get('name')
                };
    ...
    self.switch_to_user_state = function() {
        ...
        */
        ...
        return self.switch_state(state.name, {
            metadata: state.metadata,
            creator_opts: state.creator_opts
        });
    };
    ...
    self.switch_state = function(state_name, opts) {
        /**:InteractionMachine.switch_state(state_name[, opts])
        ...
        :param object opts.metadata:
            metadata about the state. Optional.
        :param object opts.creator_opts:
            options to pass to the state creator. Optional.
        ...
        */
        ...
        var p = Q(self.app.states.create(state_name, opts.creator_opts));
        return p.then(function(new_state) {
            return new_state
                .setup(self, opts.metadata)
                .then(function() {
                    return self.emit.state.exit();
                })
                .then(function() {
                    self.user.state.reset(new_state, {
                        creator_opts: opts.creator_opts
                    });
