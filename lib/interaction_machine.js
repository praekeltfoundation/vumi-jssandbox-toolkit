...
var InteractionMachine = Eventable.extend(function(self, api, app) {
    ...
    */
    ...
    self.attach = function() {
        ...
        Does the following:
            * Sets the interaction machine itself as ``api.im``. 
            * Sets the sandbox API's event handlers to emit the respective
    ...
    self.setup = function(msg, opts) {
        ...
        :param boolean opts.restart:
            whether to restart the user's data, or load them from the kv store
        ...
        */
        ...
        return Q()
            ...
            .then(function() {
                ...
                return opts.restart
                    ? self.user.setup(msg.from_addr, user_opts)
    ...
    self.switch_to_user_state = function() {
        ...
        */
        ...
        return self.switch_state(state.name, state.metadata);
    };
    ...
    self.switch_state = function(state_name, metadata) {
        /**:InteractionMachine.switch_state()
        ...
        */
        ...
        p = Q(self.app.states.create(state_name));
    ...
    self.reply = function(msg, opts) {
        ...
        */
        ...
        return self
            ...
            .then(function() {
                return Q.all([
                    self.state.continue_session(),
                    self.state.send_reply()]);
            })
            .spread(function(continue_session, send_reply) {
                return Q()
                    .then(function() {
