...
var InteractionMachine = Eventable.extend(function(api, state_creator) {
    ...
    */
    ...
    self.switch_state = function(name, metadata) {
        ...
        return p.then(function(new_state) {
            return new_state
                ...
                .then(function() {
                    self.user.set_state(name, metadata);
    ...
    self.done = function() {
        ...
        */
        if (self.is_in_state()) {
            self.user.update_state_metadata(self.state.metadata);
        }
