...
var State = Eventable.extend(function(self, name, opts) {
    ...
    self.setup = function(im, metadata) {
        ...
        */
        ...
        var before_input = self.translate.before_input;
        self.translate.before_input = before_input || function(i18n) {
            return self.translate(i18n);
        };

        var before_display = self.translate.before_display;
        self.translate.before_display = before_display || function(i18n) {
            return self.translate(i18n);
        };
    ...
    self.input = function(content) {
        ...
        */
        var p = Q(self.translate.before_input(self.im.user.i18n));
    ...
    self.show = function() {
        ...
        Translates the state using :meth:`State.translate.before_display`, then
        displays its text.  May return a promise.
        */
        var p = Q(self.translate.before_display(self.im.user.i18n));
        return p.then(function() {
            return self.display();
        });
    };
    ...
    self.translate.before_input = function(i18n) {
        /**:State.translate.before_input(i18n)
    ...
    self.translate.before_display = function(i18n) {
        /**:State.translate.before_display(i18n)
        Translate's a state's text using the given translator. Invoked before
