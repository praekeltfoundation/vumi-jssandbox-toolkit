...
function State(name, opts) {
    ...
    self.setup_state = function(im) {
         ...
         */
        self.im = im;
        return utils.call_possible_function(self.handlers.setup_state);
    };
    ...
    self.on_enter = function() {
         ...
         * May return a promise instead of returning immediately.
         **/
        return utils.call_possible_function(self.handlers.on_enter);
    };
    ...
    self.on_exit = function() {
         ...
         * May return a promise instead of returning immediately.
         **/
        return utils.call_possible_function(self.handlers.on_exit);
    };
