...
var Choice = Extendable.extend(function(value, label) {
...
var ChoiceState = State.extend(function(name, opts) {
    ...
    */
    ...
    self.on('state:input', function(event) {
        ...
        var p = Q(utils.maybe_call(self.next, self, [choice]));
        return p.then(function(next) {
            self.im.user.set_state(next);
...
var LanguageChoice = ChoiceState.extend(function(name, opts) {
...
var PaginatedChoiceState = ChoiceState.extend(function(name, opts) {
