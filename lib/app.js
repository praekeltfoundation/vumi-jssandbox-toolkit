    ...
    */
    ...
    self.add.creator = function(name, creator) {
        /**:AppStates.add.creator(name, creator)
         ...
         state name. State creators can also delegate to other state creators
         by using :meth:`AppStates.create`.
    ...
    self.create = function(name) {
        ...
        */
        ...
        return Q(creator.call(self.app, name))
            .then(function(state) {
