...
var AppStateError = BaseError.extend(function(self, app, message) {
    ...
    */
    ...
    self.setup = function(im) {
        ...
        self.on('app:error', function(e) {
            return self.im.log(e.error.message);
        });
