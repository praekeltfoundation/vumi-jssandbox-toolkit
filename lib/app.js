    ...
    */
    ...
    self.add_creator = function(state_name, creator) {
        /**:App.add_creator(state_name, creator)
         ...
         Adds a state creator. Invoked by :meth:`App.create_state`, or
        ...
        */
        ...
        if (state_name in self.creators) {
            throw new StateError("Duplicate state '" + state_name + "'");
        }

        self.creators[state_name] = creator;
        return self;
    };
    ...
    self.creators.__error__ = function(state_name) {
        /**:App.creators.__error__(state_name)
         *
    ...
    self.creators.__start__ = function(state_name) {
        /**:State.creators.__start__(state_name)
        ...
        */
        var creator = self.creators[state_name];
    ...
    self.check_created_state = function(state, state_name) {
        ...
        Used by :meth:`App.create_state` to ensure that an invoked
        ...
        */
        ...
        check(
            state.name == state_name || state.name == '__error__',
    ...
    self.create_state = function(state_name) {
        /**:App.create_state(state_name)
        ...
        */
        ...
        else if (state_name in self.creators) {
            creator = self.creators[state_name];
        }
        else {
            self.im.log(
