...
var CheckTasks = AppTesterTasks.extend(function(self, tester) {
    ...
    self.get_reply = function() {
        ...
        var reply = replies[0];
        self.check_char_limit(reply, self.tester.data.char_limit);
        return reply;
    };

    self.check_char_limit = function(reply, n) {
...
.
    ...
    self.methods.check.reply = function(v) {
        ...
        */
        ...
        Checks that the the reply sent back to the user during the sandbox run
        deep equals ``obj``.
