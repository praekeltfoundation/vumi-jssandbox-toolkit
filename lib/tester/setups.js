...
var SetupTasks = AppTesterTasks.extend(function(self, tester) {
    ...
    self.finalise.kv = function(api, data) {
        _.defaults(api.kv_store, data.kv);
    };
    ...
    self.finalise.user = function(api, data) {
        ...
        api.kv_store[user.key()] = _.defaults(
    ...
    self.methods.setup.user.state.creator_opts = function(opts) {
        ...
        */
        var state = self.data.user.state;
        state.creator_opts = utils.update(state.creator_opts || {}, opts);
    };
    ...
    self.methods.setup.user.metadata = function(metadata) {
        ...
        */
        ...
        user.metadata = utils.update(user.metadata || {}, metadata);
    };
    ...
    self.methods.setup.kv = function(v) {
        ...
        */
        ...
        :param function fn:
            ...
            store data data and ``this`` is the :class:`AppTester` instance.
            The kv store is then set with ``fn``'s result.
