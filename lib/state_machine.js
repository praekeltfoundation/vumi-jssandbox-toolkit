...
function InteractionMachine(api, state_creator) {
    ...
    */
    ...
    self.refresh_i18n = function() {
        ...
        Re-fetches the appropriate i18n translations if the users language
        setting has changed since they were loaded. Sets ``self.i18n`` to
        a new ``jed`` instance and sets ``self.i18n_lang`` to
        ``self.user.lang``.
