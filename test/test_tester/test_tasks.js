...
describe("tester.tasks", function() {
    describe("AppTesterTasks", function() {
        ...
        describe(".schedule", function() {
            ...
            it("should schedule the given task function for next run",
            function() {
                var spammed = false;
        ...
        describe(".run", function() {
            ...
            it("should invoke the before each hook before each task",
            function() {
                var record = [];
            ...
            it("should invoke the after each hook after each task",
            function() {
                var record = [];
